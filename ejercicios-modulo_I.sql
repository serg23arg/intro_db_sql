...
especificada en el siguiente documento: 
https://drive.google.com/file/d/1C0tpnf2sy8wxMEP-6doY8jGUup7582Ut/view?usp=sharing */


create table agenda (ID_contacto int primary key,
					 nombre varchar(20) not null,
                     apellido varchar(15) not null,
                     domicilio varchar(50),
                     teléfono int not null);

/*4. Visualizar las tablas existentes en la base de
datos para verificar la creación de la tabla
“AGENDA”.*/

show tables;

/*5. Visualizar la estructura de la tabla
“AGENDA”.*/

desc agenda;

/*6. Agregar el campo MAIL a la tabla. Este
...
/*7. Insertar 4 registros en la tabla “AGENDA”.*/

insert into agenda values
(1,'Sergio','Plaza','Neuquén 1060',111222333,'sergio@mail.com'),
(2,'Pedro','Ramos','Junin 800',222111222,'pedro@mail.com'),
(3,'José','Juarez','Rivadavia 234',333444555,'jose@mail.com'),
(4,'Alberto','Nuñez','Espinosa 1000',444555777,'alberto@mail.com');
...
tablas, según la estructura indicada en este documento:
https://drive.google.com/file/d/1rfG5HbnSn8sNVEAfCTAo1qwfXOd55tVZ/view?usp=sharing */

create database libreria;
use libreria;

create table autores (autor_id VARCHAR(11),apellido VARCHAR(40),nombre VARCHAR(20),telefono VARCHAR(12),
direccion VARCHAR(40),ciudad VARCHAR(20),provincia CHAR(2),c_postal CHAR(5),
estado TINYINT(1));

create table ventas (local_id CHAR(4),factura_nro VARCHAR(20),fecha DATETIME,
...
create table libros (libro_id VARCHAR(6),titulo VARCHAR(80),categoria CHAR(12),editorial_id CHAR(4),
precio DOUBLE,comentarios VARCHAR(200),fecha_publicacion DATETIME);

create table libroautor (autor_id VARCHAR(11),libro_id VARCHAR(6));

create table empleados (empleado_id CHAR(9),nombre VARCHAR(20),apellido VARCHAR(30),puesto_id SMALLINT,
editorial_id CHAR(4),fecha_ingreso DATETIME);
...
('0877','Ediciones de la Flor','BuenosAires','CF','Argentina'),
('1389','Abeledo-Perrot','Buenos Aires','CF','Argentina'),
('1622','Amorrortu Editores','BuenosAires','CF','Argentina'),
('1756','Editorial Atlántida','BuenosAires','CF','Argentina'),
('9901','Centro Editor de América Latina','BuenosAires','CF','Argentina'),
('9952','Editorial Columba','BuenosAires','CF','Argentina'),
('9999','Editorial Emecé','BuenosAires','CF','Argentina');
...
('MC3026','The PsychologyofComputerCooking','Sin asignar','0877',NULL,'','2004-12-13 00:00:00'),
...
/*3. Definir las claves primarias (Primary Key) en cada tabla. Tener
en cuenta que cada tabla tiene un campo con el sufijo _id que identifica al campo clave.
Consideraciones: La lógica del negocio indica que
un mismo número de factura se puede repetir en
varios locales y en un mismo local, pero con
distintos códigos de libros y la combinación de
autor/libro es única.*/
...
/*4. Examinar los datos ingresados, e insertar 3
registros en cada una de las tablas*/

# select autor_id from autores;
INSERT INTO autores VALUES 
('999-00-0001','Plaza','Sergio','44967223','','Salto','ER','4025',1),
('999-00-0002','Frisoli','Melisa','49867020','','Buenos Aires','CF','4618',1),
('999-00-0003','Fiori','Santiago','45487723','','Lima','LI','4705',1);

# desc editoriales;
# select editorial_id from editoriales;
INSERT INTO editoriales VALUES 
('0001','Editorial A','Buenos Aires','CF','Argentina'),
('0002','Editorial B','Buenos Aires','CF','Argentina'),
('0003','Editorial C','Buenos Aires','CF','Argentina');

# desc empleados;
# select empleado_id from empleados;
INSERT INTO empleados VALUES 
('CR000001M','Cristian','Roldán',13,'0877','1992-08-27 00:00:00'),
('CA000002M','César','Averbuch',14,'1389','1990-12-24 00:00:00'),
('CA000003M','Romina','Laino',6,'0877','1990-09-13 00:00:00');
...
INSERT INTO libros VALUES 
('SP0001','La leyenda del monstruo','Novelas','1389',19.99,'','1991-06-12 00:00:00'),
('MF0001','El Imperio Romano 2','Historia','0877',22.98,NULL,'1904-06-12 00:00:00'),
('SF0001','La bendición de Dios','Novelas','1389',11.95,'','1991-06-09 00:00:00');

# desc locales;
# select local_id from locales;
INSERT INTO locales VALUES 
('0001','Yenny - El Ateneo','Petaonal San Martin 732','San Juan','SJ','98056'),
('0002','Librería Hernández','Diagonal 104 1436','Puerto Iguazú','MI','92789'),
('0003','Librería Santa Fe','Ovidio Lagos 3253','Gobernador Gregores','SC','96745');
...
# desc ventas;
INSERT INTO ventas VALUES 
('6380','6871','1994-09-14 00:00:00',5,'Efectivo','SP0001'),
('6380','6871','1994-09-14 00:00:00',5,'Efectivo','MF0001'),
('6380','6871','1994-09-14 00:00:00',5,'Efectivo','SF0001');